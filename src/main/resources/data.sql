...
INSERT INTO namu.store (
    ...
    pickup_time, closed_days, store_rating, favorite_count, review_count, ceo_name, company_name,
    company_address, business_number, country_of_origin, status, create_at, update_at
)
VALUES
    (
        ...
        '요거트 아이스크림 요거피플~\n기본 보냉팩 포장!!\n요거피플 동래점은 부산에서 양 젤 많은 무지방 요거트 아이스크림입니당\n우유는 국내 1등 서울우유 무지방만 취급합니다.\n당일 경매 받은 신선한 과일만 취급합니다:):)',
        '19:00~22:00', NULL, 4.0, 12, 3, '박준성', '요거피플 동래점', '부산광역시 동래구 수안동 188-6 2층 5호(수안동)',
        '763-17-02432', '요거트 가루(네덜란드산), 우유(국내산), 벌집꿀(국내산)', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
    ),
    (
        ...
        '0507-1388-8812', NULL, NULL, '10:00~20:00', NULL, 4.9, 435, 356, '정영우', '카페 그라운드',
        '부산광역시 금정구 장전동 409-26 1,2층(장전동)', '316-29-00793', '원두: 수입산 / 우유: 국산 / 버터: 프랑스산 / 크림: 프랑스산 / 밀가루: 프랑스산 / 초콜렛: 프랑스산, 벨기에산 / 딸기: 국산 / 그 외 과일: 수입산 / 녹차: 국산', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
    ),
    (
        ...
        '12:00~22:00', NULL, 5.0, 172, 200, '정은영', '모리커피 부산온천장점',
        '부산 동래구 온천장로65번길 9 111호(온천동, 동래 3차 SK VIEW)', '603-25-73135', '원두 : 아라비카100% (콜롬비아,과테말라,브라질) 우유:서울우유(국산원유100%)', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
    );
